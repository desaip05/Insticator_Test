 ...
 *
 * ```js
 *   var insticatorDev = angular.module('insticatorDev', ['insticator', 'ngMockE2E']);
 *   insticatorDev.run(function($httpBackend) {
 ...
 *
 * ## Example
 * <example name="httpbackend-e2e-testing" module="insticatorE2E" deps="angular-mocks.js">
 * <file name="app.js">
 *   var insticator = angular.module('insticator', []);
 *
 *   insticator.controller('MainCtrl', function MainCtrl($http) {
 *     var ctrl = this;
 *
 *     ctrl.phones = [];
 *     ctrl.newPhone = {
 ...
 * </file>
 * <file name="e2e.js">
 *   var insticatorDev = angular.module('insticatorE2E', ['insticator', 'ngMockE2E']);
 *
 *   insticatorDev.run(function($httpBackend) {
 *     var phones = [{name: 'phone1'}, {name: 'phone2'}];
 *
...
(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('insticatorlicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('insticatorlicationModule'));
   *
   *
